...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('main', '0002_rename_id_ketegortovara_tovar_id_kategortovara_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tg_User_ID', models.CharField(blank=True, max_length=255, null=True)),
                ('StatusID', models.ForeignKey(default=2, on_delete=django.db.models.deletion.SET_DEFAULT, to='main.statusdostupa')),
